                        ...
                        <CForm className="row g-3 m-2 p-1" onSubmit={handleSubmit}>
                            ...
                            <CRow>
                                <CCol xs={12} md={3}>
                                    ...
                                    <CFormInput size="sm" id="inputAddress" value="21 Sep 2021 12:00:00 PM" readOnly />
                                </CCol>
                                <CCol xs={12} md={3}>
                            ...
                            <CRow>
                                ...
                                <CCol
                                    ...
                                    style={{ display: 'flex', justifyContent: 'space-between', height: '50px', marginRight: '550px' }}
                                >
                                    <CButton
                                        size="lg"
                                        color="warning"
                                ...
                                <CCol
                                    className="mt-3 offset-md-0 py-2"
                                    xs={3}
                                    sm={3}
                                    md={3}
