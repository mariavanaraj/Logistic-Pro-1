...
import { CButton, CCard, CCardImage, CCol, CContainer, CForm, CFormInput, CFormLabel, CModal, CModalBody, CModalFooter, CModalHeader, CModalTitle, CNav, CNavItem, CNavLink, CRow, CTabContent, CTable, CTableBody, CTableDataCell, CTableHead, CTableHeaderCell, CTableRow, CTabPane } from "@coreui/react"
...
const TripSheetSettleMentFG = () => {
  ...
  return (
    <CCard>
      <CNav variant="pills" size="sm" className="m-2" role="tablist">
            <CNavItem>
              <CNavLink
      ...
      <CRow>
        ...
        <CCol xs={12} md={3}>
          ...
          <CFormInput
            ...
            readOnly
          />
          <CModal visible={ClosingOdometerPhoto} onClose={() => setClosingOdometerPhoto(false)}>
            <CModalHeader>
...
<CTable >
  <CTableHead style={{background:"#4D3227"}}>
    <CTableRow >
      <CTableHeaderCell style={{color:"#fff"}} scope="col">Shipments</CTableHeaderCell>
      <CTableHeaderCell style={{color:"#fff"}} scope="col">Income</CTableHeaderCell>
      <CTableHeaderCell style={{color:"#fff"}} scope="col">Expenses</CTableHeaderCell>
      <CTableHeaderCell  style={{color:"#fff"}} scope="col">Profit / Loss</CTableHeaderCell>
    </CTableRow>
  </CTableHead>
<CTableBody>
  <CTableRow>
...
<CTableDataCell>38500</CTableDataCell>
  ...
  <CTableHead style={{background:"#4D3227"}}>
    <CTableRow >
      <CTableHeaderCell style={{color:"#fff",textAlign:"center"}} colSpan="2" scope="col">Income</CTableHeaderCell>
    </CTableRow>
  </CTableHead>
<CTableBody>
  <CTableRow>
...
<CTableDataCell>54000</CTableDataCell>
  ...
  <CTableHead style={{background:"#4D3227"}}>
    <CTableRow >
      <CTableHeaderCell style={{color:"#fff",textAlign:"center"}} colSpan="2" scope="col">Expenses</CTableHeaderCell>
    </CTableRow>
  </CTableHead>
<CTableBody>
  <CTableRow>
...
<CTableDataCell>54000</CTableDataCell>
  ...
  <CTableHead style={{background:"#4D3227"}}>
    <CTableRow >
      <CTableHeaderCell style={{color:"#fff",textAlign:"center"}} colSpan="2" scope="col">Mileage (KM)</CTableHeaderCell>
    </CTableRow>
  </CTableHead>
<CTableBody>
  <CTableRow>
  ...
  <h2 className="p-3">Profit : 38500</h2>
    ...
    <CRow>
      <CCol
        ...
        <CCol
          className="mt-3 offset-md-7  py-2"
          xs={12}
          sm={12}
          md={2}
        >
